...
function gSacrifice() {
    ...
    player = {
        ...
        currentChallenge: player.currentChallenge,
        infinityUpgrades: player.infinityUpgrades,
        infinityPoints: player.infinityPoints.plus(player.galaxies * player.money.log(10) / new Decimal('1.80e308').log(10)),
        infinitied: player.infinitied,
        infinitiedBank: player.infinitiedBank,
        totalTimePlayed: player.totalTimePlayed,
        bestInfinityTime: player.bestInfinityTime,
...
function gameLoop(diff) {
    ...
    if (player.money.gte(Number.MAX_VALUE) && (((player.currentChallenge != "" && player.money.gte(player.challengeTarget)) && !player.options.retryChallenge) || (player.bestInfinityTime > 600 && !player.break))) {
        ...
        if (player.infinitied > 0 || player.infinityPoints.gt(0)) {
    ...
    let ipShow = player.infinityPoints.lt(10) ? player.infinityPoints.toFixed(3) : shortenDimensions(player.infinityPoints);
    document.getElementById("infinityPoints1").innerHTML = "You have <span class=\"IPAmount1\">"+ipShow+"</span> Infinity points."
    document.getElementById("infinityPoints2").innerHTML = "You have <span class=\"IPAmount2\">"+ipShow+"</span> Infinity points."
