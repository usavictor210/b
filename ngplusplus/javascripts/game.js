...
function updateDimensions() {
    ...
    if (document.getElementById("infinity").style.display == "block") {
        if (document.getElementById("preinf").style.display == "block") {
            ...
            document.getElementById("infi31").innerHTML = "Normal dimensions gain a multiplier based on time spent in the current infinity.<br>Currently: " + timeMultUpg(2) + "x<br>Cost: 3 IP"
...
function gameLoop(diff) {
    ...
    document.getElementById("theorembuyers").display.style = ""
