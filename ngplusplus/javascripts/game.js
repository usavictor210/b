...
function updateDimensions() {
    ...
    if (document.getElementById("infinity").style.display == "block") {
        if (document.getElementById("preinf").style.display == "block") {
            document.getElementById("infi11").innerHTML = "Normal dimensions gain a multiplier based on time played.<br>Currently: " + shortenMoney(timeMultUpg(1, 2)) + "x<br>Cost: 1 IP"
            ...
            document.getElementById("infi31").innerHTML = "Normal dimensions gain a multiplier based on time spent in the current infinity.<br>Currently: " + shortenMoney(timeMultUpg(2, 2)) + "x<br>Cost: 3 IP"
