...
function getTimeDimensionPower(tier) {
  ...
  if (player.timestudy.studies.includes(262) && tier == 2) ret = ret.times(Decimal.pow(calcTotalSacrificeBoost().log10(), (25 + (calcTotalSacrificeBoost().log(1000) / 10000))).max(1))
